...
## AggregateAvg dstat_log_AggregatMin output_log_AggregateMin
...
do
	...
	echo -e "\n\n\n***** AggregateAvg - integer_2gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/dstat_logs/Cluster5/dstat_log_AggregatMin	#****


	##printing on output log file
	echo -e "\n\n\n***** AggregateAvg - integer_2gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateMin	#****
...
do
	...
	##printing on dstat log file
	echo -e "\n\n\n***** AggregateAvg - integer_4gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/dstat_logs/Cluster5/dstat_log_AggregatMin	#****


	##printing on output log file
	echo -e "\n\n\n***** AggregateAvg - integer_4gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateMin	#****
...
do
	...
	##printing on dstat log file
	echo -e "\n\n\n***** AggregateAvg - integer_8gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/dstat_logs/Cluster5/dstat_log_AggregatMin	#****


	##printing on output log file
	echo -e "\n\n\n***** AggregateAvg - integer_8gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateMin	#****
...
do
	...
	##printing on dstat log file
	echo -e "\n\n\n***** AggregateAvg - integer_16gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/dstat_logs/Cluster5/dstat_log_AggregatMin	#****


	##printing on output log file
	echo -e "\n\n\n***** AggregateAvg - integer_16gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateMin	#****
...
do
	...
	##printing on dstat log file
	echo -e "\n\n\n***** AggregateAvg - integer_32gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/dstat_logs/Cluster5/dstat_log_AggregatMin	#****


	##printing on output log file
	echo -e "\n\n\n***** AggregateAvg - integer_32gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateMin	#****
...
do
	...
	##printing on dstat log file
	echo -e "\n\n\n***** AggregateAvg - string_2gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/dstat_logs/Cluster5/dstat_log_AggregatMin	#****


	##printing on output log file
	echo -e "\n\n\n***** AggregateAvg - string_2gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateMin	#****
...
do
	...
	##printing on dstat log file
	echo -e "\n\n\n***** AggregateAvg - string_4gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/dstat_logs/Cluster5/dstat_log_AggregatMin	#****


	##printing on output log file
	echo -e "\n\n\n***** AggregateAvg - string_4gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateMin	#****
...
do
	...
	##printing on dstat log file
	echo -e "\n\n\n***** AggregateAvg - string_8gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/dstat_logs/Cluster5/dstat_log_AggregatMin	#****


	##printing on output log file
	echo -e "\n\n\n***** AggregateAvg - string_8gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateMin	#****
...
do
	...
	##printing on dstat log file
	echo -e "\n\n\n***** AggregateAvg - string_16gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/dstat_logs/Cluster5/dstat_log_AggregatMin	#****


	##printing on output log file
	echo -e "\n\n\n***** AggregateAvg - string_16gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateMin	#****
...
do
	...
	##printing on dstat log file
	echo -e "\n\n\n***** AggregateAvg - string_32gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/dstat_logs/Cluster5/dstat_log_AggregatMin	#****


	##printing on output log file
	echo -e "\n\n\n***** AggregateAvg - string_32gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateMin	#****
