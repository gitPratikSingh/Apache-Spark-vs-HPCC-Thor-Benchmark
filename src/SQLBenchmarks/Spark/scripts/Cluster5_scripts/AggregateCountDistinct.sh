...
do
	...
	echo -e "\n\n\n***** AggregateCountDistinct - integer_2gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/dstat_logs/Cluster5/dstat_log_AggregateCountDistinct	#****


	##printing on output log file
	echo -e "\n\n\n***** AggregateCountDistinct - integer_2gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateCountDistinct	#****
	...
	sudo spark-submit --class AggregateCountDistinct --deploy-mode cluster --master yarn --num-executors 5 --executor-cores 5 --executor-memory 4g /home/ec2-user/RamBharose/exp_jars/SparkBenchmark_cluster.jar hdfs:///user/hadoop/datasets/integer/integer_2gb.csv 1  &>> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateCountDistinct  #****
...
do
	...
	##printing on dstat log file
	echo -e "\n\n\n***** AggregateCountDistinct - integer_4gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/dstat_logs/Cluster5/dstat_log_AggregateCountDistinct	#****


	##printing on output log file
	echo -e "\n\n\n***** AggregateCountDistinct - integer_4gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateCountDistinct	#****
...
do
	...
	##printing on dstat log file
	echo -e "\n\n\n***** AggregateCountDistinct - integer_8gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/dstat_logs/Cluster5/dstat_log_AggregateCountDistinct	#****


	##printing on output log file
	echo -e "\n\n\n***** AggregateCountDistinct - integer_8gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateCountDistinct	#****
...
do
	...
	##printing on dstat log file
	echo -e "\n\n\n***** AggregateCountDistinct - integer_16gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/dstat_logs/Cluster5/dstat_log_AggregateCountDistinct	#****


	##printing on output log file
	echo -e "\n\n\n***** AggregateCountDistinct - integer_16gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateCountDistinct	#****
...
do
	...
	##printing on dstat log file
	echo -e "\n\n\n***** AggregateCountDistinct - integer_32gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/dstat_logs/Cluster5/dstat_log_AggregateCountDistinct	#****


	##printing on output log file
	echo -e "\n\n\n***** AggregateCountDistinct - integer_32gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateCountDistinct	#****
...
do
	...
	##printing on dstat log file
	echo -e "\n\n\n***** AggregateCountDistinct - string_2gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/dstat_logs/Cluster5/dstat_log_AggregateCountDistinct	#****


	##printing on output log file
	echo -e "\n\n\n***** AggregateCountDistinct - string_2gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateCountDistinct	#****
...
do
	...
	##printing on dstat log file
	echo -e "\n\n\n***** AggregateCountDistinct - string_4gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/dstat_logs/Cluster5/dstat_log_AggregateCountDistinct	#****


	##printing on output log file
	echo -e "\n\n\n***** AggregateCountDistinct - string_4gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateCountDistinct	#****
...
do
	...
	##printing on dstat log file
	echo -e "\n\n\n***** AggregateCountDistinct - string_8gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/dstat_logs/Cluster5/dstat_log_AggregateCountDistinct	#****


	##printing on output log file
	echo -e "\n\n\n***** AggregateCountDistinct - string_8gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateCountDistinct	#****
...
do
	...
	##printing on dstat log file
	echo -e "\n\n\n***** AggregateCountDistinct - string_16gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/dstat_logs/Cluster5/dstat_log_AggregateCountDistinct	#****


	##printing on output log file
	echo -e "\n\n\n***** AggregateCountDistinct - string_16gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateCountDistinct	#****
...
do
	...
	##printing on dstat log file
	echo -e "\n\n\n***** AggregateCountDistinct - string_32gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/dstat_logs/Cluster5/dstat_log_AggregateCountDistinct	#****


	##printing on output log file
	echo -e "\n\n\n***** AggregateCountDistinct - string_32gb.csv" >> /home/ec2-user/RamBharose/experiment_logs/output_logs/Cluster5/output_log_AggregateCountDistinct	#****
